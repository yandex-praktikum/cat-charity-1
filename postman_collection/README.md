...
Файл `QRKot-1.postman_collection.json` содержит postman-коллекцию - набор подготовленных запросов для проверки работы API.
...
*После подготовки проекта создайте копию файла базы данных: она может пригодиться для повторного запуска коллекции.*
...
Загрузите файл `QRKot-1.postman_collection.json` в Postman.
